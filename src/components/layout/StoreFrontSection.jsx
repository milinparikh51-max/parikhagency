                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                    ...
                    <div className="lg:col-span-6 order-1 lg:order-2 text-left space-y-8">
                        <div className="space-y-4">
                            ...
                            >
                                Serving creators with trust and premium vibes since 1979. Whether you're upgrading your desk aesthetic, prepping for exams, or building custom team merchandise — we bring you the ultimate vibe check in stationery.
                            </motion.p>
                        </div>
                        ...
                        >
                            <div className="p-4 bg-white/5 backdrop-blur-md rounded-2xl border border-white/5 hover:border-[#7c3aed]/30 transition-all duration-300">
                                <h4 className="text-3xl font-black text-[#00ff87] mb-1">45+ Yrs</h4>
